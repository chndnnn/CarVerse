const Footer = ()=>{
    return <footer className="bg-gray-100 mt-10">
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      <div className="flex justify-center text-teal-600">
      </div>
  
      <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
      Carverse is your trusted platform for exploring, comparing, and purchasing a wide range of vehicles. Whether you're looking for a family car, a luxury ride, or an eco-friendly option, we are here to help you make informed decisions with ease.
      </p>
